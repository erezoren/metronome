...
function preset(pretempo, lable) {
  document.getElementById('songTitle').innerText = lable;
  document.getElementById('tempo').value = pretempo;
  tempo = pretempo;
  document.getElementById('showTempo').innerText = pretempo;
}

function addPreset(lable) {

  var randId = "pre" + Date.now();
  var br = document.createElement("BR");
  var preset = document.createElement("DIV");

  var song = document.createElement("LABEL");
  song.innerText = lable;
  var tempo = document.createElement("INPUT");
  tempo.setAttribute("type", "number");
  tempo.setAttribute("id", randId);
  ...
  preset.appendChild(play);

  document.getElementById("presets").appendChild(br);
  document.getElementById("presets").appendChild(preset);

}

function callback(pretempo) {
  return function () {
    preset(pretempo)
  }
}
